...
public sealed class GitHubMarkdownPreprocessorTests
{
    ...
    {
        var input = "fix: thing by @beelzer in https://github.com/beelzer/salvo/pull/53";
        var output = GitHubMarkdownPreprocessor.Rewrite(input);
        output.Should().Contain("[#53](https://github.com/beelzer/salvo/pull/53)");
    }

    [Fact]
    public void Rewrite_IssueUrl_BecomesShortHashLink()
    {
        var input = "closes https://github.com/beelzer/salvo/issues/42";
        var output = GitHubMarkdownPreprocessor.Rewrite(input);
        output.Should().Contain("[#42](https://github.com/beelzer/salvo/issues/42)");
    }

    [Fact]
    public void Rewrite_CompareUrl_BecomesTagSpanLink()
    {
        var input = "**Full Changelog**: https://github.com/beelzer/salvo/compare/v0.2.14-canary.10...v0.2.14-canary.11";
        var output = GitHubMarkdownPreprocessor.Rewrite(input);
        output.Should().Contain("[v0.2.14-canary.10...v0.2.14-canary.11](https://github.com/beelzer/salvo/compare/v0.2.14-canary.10...v0.2.14-canary.11)");
    }
    ...
    {
        var input = "review the [original PR](https://github.com/beelzer/salvo/pull/53)";
        var output = GitHubMarkdownPreprocessor.Rewrite(input);
        output.Should().Be(input);
    }
    ...
    public void Rewrite_RealReleaseBody_ProducesExpectedLinks()
    {
        ...
        var input = "## What's Changed\n* fix: thing by @beelzer in https://github.com/beelzer/salvo/pull/53\n\n**Full Changelog**: https://github.com/beelzer/salvo/compare/v0.2.14-canary.10...v0.2.14-canary.11";
        var output = GitHubMarkdownPreprocessor.Rewrite(input);
        ...
        output.Should().NotMatchRegex(@"(?<!\()https://github\.com/beelzer/salvo/(pull|compare)/");
    }
